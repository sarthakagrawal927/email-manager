...
This directory holds the short-form, current-state view of email-manager. For
the durable knowledge base, see the parent [`README.md`](../README.md).
...
- [`../../PROJECT_STATUS.md`](../../PROJECT_STATUS.md) — detailed timeline of
  ...
  fleet contract checks verify its presence.
