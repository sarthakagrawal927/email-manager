#!/usr/bin/env node
// Documentation validation for the email-manager knowledge system.
//
// Checks:
...
const requiredFiles = [
  ...
  'docs/operations/runbooks/local-dev.md',
  'docs/operations/runbooks/oauth-setup.md',
  'docs/operations/runbooks/digest-verify.md',
