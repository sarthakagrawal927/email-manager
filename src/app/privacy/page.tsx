...
export const metadata = {
  title: "Privacy — Email Manager",
  description: "What Email Manager reads, what it stores, and what it never sends.",
};
  ...
  return (
    <main className="mx-auto max-w-3xl px-4 py-12 text-sm leading-7">
      ...
      <ul className="mt-2 list-disc space-y-1 pl-5">
        <li>Your Gmail metadata — sender, recipient, subject, labels, timestamps — via the Gmail API.</li>
        <li>Message bodies are read only when needed to classify a suggestion; never persisted beyond the session.</li>
        <li>Your filter list, so we can show you what&apos;s already in place vs. what&apos;s being suggested.</li>
      </ul>
      ...
      <ul className="mt-2 list-disc space-y-1 pl-5">
        ...
        <li>Share or sell your data — the entire app is built around <em>reducing</em> the email surface area you&apos;re exposed to.</li>
      ...
      <p className="mt-2">
        ...
        immediately. Any installed Gmail filters remain in Gmail until you
        remove them there.
      </p>
    </main>
  );
