...
describe("buildGmailFilterSuggestions", () => {
  it("groups newsletter emails by sender", () => {
    const emails: Email[] = [
      makeEmail({ from: "News <news@corp.com>", subject: "Weekly newsletter", snippet: "unsubscribe" }),
      makeEmail({ from: "News <news@corp.com>", subject: "Another newsletter", snippet: "view in browser" }),
    ];
